...
insert into ordertable (customer_CustID, ordertable_OrderType, ordertable_OrderDateTime, ordertable_CustPrice, ordertable_BusPrice, ordertable_IsComplete) values
    (null, 'dinein', '2025-01-05 12:03:00', 19.75, 3.68, 1),
    (null, 'dinein', '2025-02-03 12:05:00', 12.85+6.93, 3.23+1.40, 1),
    (1, 'pickup', '2025-01-03 21:30:00', 14.88*6, 3.30*6, 1),
    (1, 'delivery', '2025-02-20 19:11:00', 68.95, 20.99, 1),
    (2, 'pickup', '2025-01-02 17:30:00', 28.70, 7.84, 1),
    (3, 'delivery', '2025-01-02 18:17:00', 25.81, 3.64, 1),
    (4, 'delivery', '2025-02-13 20:32:00',31.66, 2.75+3.25, 1);
...
insert into pizza_discount values
    (1, 3),
    (2, 2),
    (2, 4),
    (11, 4),
