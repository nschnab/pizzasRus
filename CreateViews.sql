...
select o.ordertable_OrderType as CustomerType, string(o.ordertable_OrderDateTime) as OrderMonth, o.ordertable_CustPrice as TotalOrderPrice, o.ordertable_BusPrice as OrderTotalCost, o.ordertable_CustPrice - o.ordertable_BusPrice as Profit
from ordertable o;